...
export interface GetUserAccessInterface extends UseCase<GetUserAccessInterface.Request, GetUserAccessInterface.Response> {
  execute(queryString: GetUserAccessInterface.Request): Promise<GetUserAccessInterface.Response>;
}
